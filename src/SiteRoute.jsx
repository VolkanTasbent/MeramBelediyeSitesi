  ...
  return (
    <div>
      <Routes>
        ...
        <Route
          path="/hizmetlerimiz/basvuruklavuzu"
          element={<BasvuruKilavuzu />}
        />
        <Route
          path="/hizmetlerimiz/ruhsatislemleri"
          element={<Ruhsatislemleri />}
        />
        <Route
          path="/hizmetlerimiz/sikcasorulansorular"
          element={<SikcaSorulan />}
        />
