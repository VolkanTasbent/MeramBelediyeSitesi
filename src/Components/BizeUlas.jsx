    ...
    <footer className="row">
      <div className=" footerrow  ">
        ...
        <div className="footercol col" style={{}}>
          ...
          <a href="https://twitter.com/MeramBelediyesi" style={{}}>
            {' '}
            <button type="button" className="btn btn-primary">
              <i className="bi bi-twitter"></i>
            </button>
          </a>
          <a href="https://www.youtube.com/user/merambelediyesi" style={{}}>
            {' '}
            <button type="button" className="btn btn-danger">
        ...
        <div className="col footercol ">
          <h5>
            <i className="bi bi-geo-alt-fill"></i> Yenişehir Mahallesi
            Azerbaycan Caddesi No: 5 42010 Meram / KONYA
          </h5>
        </div>
      </div>
    </footer>
