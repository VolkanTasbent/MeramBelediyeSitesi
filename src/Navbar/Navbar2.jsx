      ...
      <div className="row">
        ...
        <div className="col-md-5">
          <div className="row navitem">
            ...
            <div className="col">
              {' '}
              <NavLink className="nav-link active navitem" to="/baskan">
                Baskan
              </NavLink>
            </div>
            <div className="col">
              {' '}
              <NavLink className="nav-link active navitem" to="/meram">
                Meram
              </NavLink>
            </div>
            <div className="col">
              {' '}
              <NavLink className="nav-link active navitem" to="/iletisim">
                İletisim
              </NavLink>
            </div>
          </div>
